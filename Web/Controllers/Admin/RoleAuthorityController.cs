...
namespace Web.Controllers.Admin
{
    ...
    [Authorize("admin")]
    [QueryFilter]
    public class RoleAuthorityController : MyBaseController<RoleAuthority>
    {
        IRoleAuthorityBll bll;
        public RoleAuthorityController(IRoleAuthorityBll bll)
        {
            this.bll = bll;
        }
        // GET: api/List/RoleAuthority
        [HttpGet]
