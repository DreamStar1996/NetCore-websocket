...
public static class ImHelper
{
    ...
    public static void SendMessage(string senderClientId, IEnumerable<string> receiveClientId, object message, bool receipt = false) =>
    ...
    public static void EventChan(
     Action<(string clientId, string chan)> joinchannel,
     Action<(string clientId, string chan)> leavechannel) => Instance.EventChan(joinchannel, leavechannel);
    ...
    public static long GetChanOnline(string chan) => GetChanClientList(chan).Length;
